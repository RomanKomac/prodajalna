...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    pesmiIzRacuna(polja.seznamRacunov, function(napaka2, vrstice1){
      if(napaka2){
        odgovor.sendStatus(500);
        return;
      }
      strankaIzRacuna(polja.seznamRacunov, function(napaka3, vrstice2){
        if(napaka3){
          odgovor.sendStatus(500);
          return;
        }
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    vrniStranke(function(napaka3, stranke) {
      vrniRacune(function(napaka4, racuni) {
        if(napaka3 || napaka4 || napaka1 != null && napaka1 || napaka2 != null && napaka2)
...
streznik.post('/stranka', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    //console.log(zahteva.session.trenutnaStranka+ " logged in");
    odgovor.redirect('/')
  });
})
